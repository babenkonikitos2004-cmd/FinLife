...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  static const VerificationMeta _financialGoalMeta =
      const VerificationMeta('financialGoal');
  @override
  late final GeneratedColumn<String> financialGoal = GeneratedColumn<String>(
      'financial_goal', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, email, monthlyIncome, createdAt, gender, age, financialGoal];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<User> instance,
    ...
    if (data.containsKey('financial_goal')) {
      context.handle(
          _financialGoalMeta,
          financialGoal.isAcceptableOrUnknown(
              data['financial_goal']!, _financialGoalMeta));
    }
    return context;
  }
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      financialGoal: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}financial_goal']),
    );
  }
...
class User extends DataClass implements Insertable<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || financialGoal != null) {
      map['financial_goal'] = Variable<String>(financialGoal);
    }
    return map;
  }
  ...
  UsersCompanion toCompanion(bool nullToAbsent) {
    return UsersCompanion(
      ...
      financialGoal: financialGoal == null && nullToAbsent
          ? const Value.absent()
          : Value(financialGoal),
    );
  }
  ...
  factory User.fromJson(Map<String, dynamic> json,
    ...
    return User(
      ...
      financialGoal: serializer.fromJson<String?>(json['financialGoal']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'financialGoal': serializer.toJson<String?>(financialGoal),
    };
  }
  ...
  User copyWith(
          ...
          Value<String?> financialGoal = const Value.absent()}) =>
      User(
        id: id ?? this.id,
        name: name ?? this.name,
        ...
        financialGoal:
            financialGoal.present ? financialGoal.value : this.financialGoal,
      );
  User copyWithCompanion(UsersCompanion data) {
    return User(
      ...
      financialGoal: data.financialGoal.present
          ? data.financialGoal.value
          : this.financialGoal,
    );
  }
  ...
  String toString() {
    return (StringBuffer('User(')
          ...
          ..write('gender: $gender, ')
          ..write('age: $age, ')
          ..write('financialGoal: $financialGoal')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is User &&
          ...
          other.age == this.age &&
          other.financialGoal == this.financialGoal);
}
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  final Value<int?> age;
  final Value<String?> financialGoal;
  ...
  const UsersCompanion({
    ...
    this.financialGoal = const Value.absent(),
  ...
  static Insertable<User> custom({
    ...
    Expression<int>? age,
    Expression<String>? financialGoal,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (financialGoal.present) {
      map['financial_goal'] = Variable<String>(financialGoal.value);
    }
    if (rowid.present) {
...
class Category extends DataClass implements Insertable<Category> {
  ...
  Category copyWith({String? id, String? name, String? icon, bool? isIncome}) =>
      Category(
        id: id ?? this.id,
        name: name ?? this.name,
        icon: icon ?? this.icon,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, categoryId, description, amount,
      type, date, isRecurring, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, userId, categoryId, name, amount, startDate, endDate, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class FinancialGoal extends DataClass implements Insertable<FinancialGoal> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, title, description, targetAmount,
      currentAmount, targetDate, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $GamificationTable extends Gamification
    with TableInfo<$GamificationTable, GamificationData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $GamificationTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, userId, streak, achievements, lastActivity];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'gamification';
  @override
  VerificationContext validateIntegrity(Insertable<GamificationData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GamificationData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $GamificationTable createAlias(String alias) {
    return $GamificationTable(attachedDatabase, alias);
  }
}

class GamificationData extends DataClass
    implements Insertable<GamificationData> {
  final String id;
  final String userId;
  final int streak;
  ...
  GamificationCompanion toCompanion(bool nullToAbsent) {
    return GamificationCompanion(
      id: Value(id),
      userId: Value(userId),
      streak: Value(streak),
  ...
  GamificationData copyWithCompanion(GamificationCompanion data) {
    return GamificationData(
      id: data.id.present ? data.id.value : this.id,
      userId: data.userId.present ? data.userId.value : this.userId,
  ...
  @override
  String toString() {
    return (StringBuffer('GamificationData(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('streak: $streak, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, userId, streak, achievements, lastActivity);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class GamificationCompanion extends UpdateCompanion<GamificationData> {
  final Value<String> id;
  final Value<String> userId;
  ...
  GamificationCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        achievements = Value(achievements),
        lastActivity = Value(lastActivity);
  static Insertable<GamificationData> custom({
    Expression<String>? id,
    Expression<String>? userId,
  ...
  GamificationCompanion copyWith(
      {Value<String>? id,
      Value<String>? userId,
      Value<int>? streak,
  ...
  @override
  String toString() {
    return (StringBuffer('GamificationCompanion(')
          ..write('id: $id, ')
          ..write('userId: $userId, ')
          ..write('streak: $streak, ')
          ..write('achievements: $achievements, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $GamificationTable gamification = $GamificationTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [users, categories, transactions, budgets, financialGoals, gamification];
}
...
final class $$UsersTableReferences
  ...
  static MultiTypedResultKey<$FinancialGoalsTable, List<FinancialGoal>>
      _financialGoalsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.financialGoals,
              aliasName:
                  $_aliasNameGenerator(db.users.id, db.financialGoals.userId));

  $$FinancialGoalsTableProcessedTableManager get financialGoalsRefs {
    final manager = $$FinancialGoalsTableTableManager($_db, $_db.financialGoals)
        .filter((f) => f.userId.id.sqlEquals($_itemColumn<String>('id')!));
  ...
  static MultiTypedResultKey<$GamificationTable, List<GamificationData>>
      _gamificationRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
          db.gamification,
          aliasName: $_aliasNameGenerator(db.users.id, db.gamification.userId));

  $$GamificationTableProcessedTableManager get gamificationRefs {
    final manager = $$GamificationTableTableManager($_db, $_db.gamification)
        .filter((f) => f.userId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_gamificationRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$UsersTableFilterComposer extends Composer<_$AppDatabase, $UsersTable> {
  ...
  ColumnFilters<String> get financialGoal => $composableBuilder(
      column: $table.financialGoal, builder: (column) => ColumnFilters(column));
  ...
  Expression<bool> gamificationRefs(
      Expression<bool> Function($$GamificationTableFilterComposer f) f) {
    final $$GamificationTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $db.gamification,
        getReferencedColumn: (t) => t.userId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            $$GamificationTableFilterComposer(
              $db: $db,
              $table: $db.gamification,
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
              joinBuilder: joinBuilder,
              $removeJoinBuilderFromRootComposer:
                  $removeJoinBuilderFromRootComposer,
...
class $$UsersTableOrderingComposer
  ...
  ColumnOrderings<String> get financialGoal => $composableBuilder(
      column: $table.financialGoal,
      builder: (column) => ColumnOrderings(column));
}
...
class $$UsersTableAnnotationComposer
  ...
  GeneratedColumn<String> get financialGoal => $composableBuilder(
      column: $table.financialGoal, builder: (column) => column);
  ...
  Expression<T> gamificationRefs<T extends Object>(
      Expression<T> Function($$GamificationTableAnnotationComposer a) f) {
    final $$GamificationTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $db.gamification,
        getReferencedColumn: (t) => t.userId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            $$GamificationTableAnnotationComposer(
              $db: $db,
              $table: $db.gamification,
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
              joinBuilder: joinBuilder,
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              explicitlyWatchedTables: [
                ...
                if (gamificationRefs) db.gamification
              ],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  ...
                  if (financialGoalsRefs)
                    await $_getPrefetchedData<User, $UsersTable, FinancialGoal>(
                        currentTable: table,
                        referencedTable:
                            $$UsersTableReferences._financialGoalsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$UsersTableReferences(db, table, p0)
                                .financialGoalsRefs,
                        referencedItemsForCurrentItem: (item,
                  ...
                  if (gamificationRefs)
                    await $_getPrefetchedData<User, $UsersTable,
                        ...
                        currentTable: table,
                        referencedTable:
                            $$UsersTableReferences._gamificationRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$UsersTableReferences(db, table, p0)
                                .gamificationRefs,
                        referencedItemsForCurrentItem: (item,
...
final class $$FinancialGoalsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) => db.users
      .createAlias($_aliasNameGenerator(db.financialGoals.userId, db.users.id));
              ...
              addJoins: <
                ...
                if (userId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.userId,
                    referencedTable:
                        $$FinancialGoalsTableReferences._userIdTable(db),
                    referencedColumn:
                        $$FinancialGoalsTableReferences._userIdTable(db).id,
                  ) as T;
                }
...
typedef $$FinancialGoalsTableProcessedTableManager = ProcessedTableManager<
    ...
    FinancialGoal,
    PrefetchHooks Function({bool userId})>;
typedef $$GamificationTableCreateCompanionBuilder = GamificationCompanion
    Function({
  required String id,
  required String userId,
  required int streak,
...
typedef $$GamificationTableUpdateCompanionBuilder = GamificationCompanion
    Function({
  Value<String> id,
  Value<String> userId,
  Value<int> streak,
...
final class $$GamificationTableReferences extends BaseReferences<_$AppDatabase,
    $GamificationTable, GamificationData> {
  $$GamificationTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $UsersTable _userIdTable(_$AppDatabase db) => db.users
      .createAlias($_aliasNameGenerator(db.gamification.userId, db.users.id));
...
class $$GamificationTableFilterComposer
    extends Composer<_$AppDatabase, $GamificationTable> {
  $$GamificationTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$GamificationTableOrderingComposer
    extends Composer<_$AppDatabase, $GamificationTable> {
  $$GamificationTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GamificationTableAnnotationComposer
    extends Composer<_$AppDatabase, $GamificationTable> {
  $$GamificationTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$GamificationTableTableManager extends RootTableManager<
    _$AppDatabase,
    $GamificationTable,
    GamificationData,
    $$GamificationTableFilterComposer,
    $$GamificationTableOrderingComposer,
    $$GamificationTableAnnotationComposer,
    $$GamificationTableCreateCompanionBuilder,
    $$GamificationTableUpdateCompanionBuilder,
    (GamificationData, $$GamificationTableReferences),
    GamificationData,
    PrefetchHooks Function({bool userId})> {
  $$GamificationTableTableManager(_$AppDatabase db, $GamificationTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GamificationTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GamificationTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$GamificationTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> userId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$GamificationTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({userId = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (userId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.userId,
                    referencedTable:
                        $$GamificationTableReferences._userIdTable(db),
                    referencedColumn:
                        $$GamificationTableReferences._userIdTable(db).id,
                  ) as T;
                }
...
typedef $$GamificationTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $GamificationTable,
    GamificationData,
    $$GamificationTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$GamificationTableTableManager get gamification =>
      $$GamificationTableTableManager(_db, _db.gamification);
}
